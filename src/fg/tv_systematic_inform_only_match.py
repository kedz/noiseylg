...
#{'family', 'screensizerange', 'ecorating', 'hdmiport', 'hasusbport', 'pricerange', 'name'}
...
@register("d2t.tv_systematic_inform_only_match")
class TVSystematicInformOnlyMatch(PlumObject):
