from ..types import register, PlumModule, HP, props
...
@register("metrics.seq2seq_eval_script")
class Seq2SeqEvalScript(PlumModule):
    ...
    def _process_result(self):
        while True:
            hyp, refs = self._queue.get()

            print(self.postprocess(hyp), file=self._hyp_fp)
