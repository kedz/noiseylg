...
local valid_ds = PM.s2s.parallel_jsonl(
    root_dir + "data/e2e/e2e.valid.multiref.mrs.v5.delex.jsonl",
    root_dir + "data/e2e/e2e.valid.multiref.descs.v5.delex.jsonl",
    name="e2e.valid");
...
[
    ...
    ),
    {
		...
		input_path: root_dir + "data/e2e/e2e.test.mrs.v5.delex.jsonl", 
		filename: "base.delex.beam8.test.jsonl",
        delex: true,
    },
    {
        __plum_type__: "d2t.e2e_predict",
		...
		target_vocab: vocab["target"],
		input_path: root_dir + "data/e2e/e2e.test.mrs.v5.delex.jsonl", 
		filename: "base.delex.greedy.test.jsonl",
        delex: true,
    },
...
] + [
    {
		...
		source_vocab: vocab["source"],
		target_vocab: vocab["target"],
		filename: "base.delex.beam8.mr" + mrsize + ".jsonl",
        delex: true,
    },
