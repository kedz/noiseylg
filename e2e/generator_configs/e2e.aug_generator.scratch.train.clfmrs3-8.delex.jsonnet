...
local synth_data = [
    PM.data.jsonl(
        "samples/base.delex.clf.mr3.max25k.jsonl",
        name="delex.clf.mr3", mmap=true),
    PM.data.jsonl(
        "samples/base.delex.clf.mr4.max25k.jsonl",
        name="delex.clf.mr4", mmap=true),
    PM.data.jsonl(
        "samples/base.delex.clf.mr5.max25k.jsonl",
        name="delex.clf.mr5", mmap=true),
    PM.data.jsonl(
        "samples/base.delex.clf.mr6.max25k.jsonl",
        name="delex.clf.mr6", mmap=true),
    PM.data.jsonl(
        "samples/base.delex.clf.mr7.max25k.jsonl",
        name="delex.clf.mr7", mmap=true),
    PM.data.jsonl(
        "samples/base.delex.clf.mr8.max25k.jsonl",
        name="delex.clf.mr8", mmap=true),
];
...
[
    ...
    ),
    {
		...
		filename: "aug.clf.delex.beam8.valid.jsonl"
    },
    {
        __plum_type__: "d2t.e2e_predict",
		...
		filename: "aug.clf.delex.beam8.test.jsonl",
        delex: true,
    },
    {
        __plum_type__: "d2t.e2e_predict",
		...
		target_vocab: vocab["target"],
		input_path: "../data/e2e/e2e.test.mrs.v5.delex.jsonl", 
		filename: "aug.clf.delex.greedy.test.jsonl",
        delex: true,
    },
] + [
    { 
		...
		source_vocab: vocab["source"],
		target_vocab: vocab["target"],
		filename: "aug.clf.delex.beam8.mr" + mrsize + ".jsonl",
        delex: true,
    },
