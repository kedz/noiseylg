...
local synth_data = [
    PM.data.jsonl(
        "samples/base.lex.rules.mr3.max25k.jsonl",
        name="lex.rule.mr3", mmap=true),
    PM.data.jsonl(
        "samples/base.lex.rules.mr4.max25k.jsonl",
        name="lex.rule.mr4", mmap=true),
    PM.data.jsonl(
        "samples/base.lex.rules.mr5.max25k.jsonl",
        name="lex.rule.mr5", mmap=true),
    PM.data.jsonl(
        "samples/base.lex.rules.mr6.max25k.jsonl",
        name="lex.rule.mr6", mmap=true),
    PM.data.jsonl(
        "samples/base.lex.rules.mr7.max25k.jsonl",
        name="lex.rule.mr7", mmap=true),
    PM.data.jsonl(
        "samples/base.lex.rules.mr8.max25k.jsonl",
        name="lex.rule.mr8", mmap=true),
];

local train_src = PM.data.jsonl(
    "../data/e2e/e2e.train.mrs.v6.lex.jsonl", name="e2e.train.src.orig",
    mmap=true);
local train_tgt = PM.data.jsonl(
    "../data/e2e/e2e.train.descs.v6.lex.jsonl", name="e2e.train.tgt.orig",
    mmap=true);
...
local valid_ds = PM.s2s.parallel_jsonl(
    "../data/e2e/e2e.valid.multiref.mrs.v6.lex.jsonl",
    "../data/e2e/e2e.valid.multiref.descs.v6.lex.jsonl",
    name="e2e.valid");

local vocab = {
    "source": PM.vocab.load("base_generators/lex/vocabs/source_vocab.pth", name="source"),
    "target": PM.vocab.load("base_generators/lex/vocabs/target_vocab.pth", name="target"),
};
...
[
    ...
    ),
    {
		...
		filename: "aug.rule.lex.beam8.mr3.jsonl"
    },
    {
		...
		source_vocab: vocab["source"],
		target_vocab: vocab["target"],
		input_path: "../data/e2e/e2e.valid.multiref.mrs.v6.lex.jsonl", 
		filename: "aug.rule.lex.beam8.valid.jsonl"
    },
    {
        __plum_type__: "d2t.e2e_predict",
		...
		source_vocab: vocab["source"],
		target_vocab: vocab["target"],
		input_path: "../data/e2e/e2e.test.mrs.v6.lex.jsonl", 
		filename: "aug.rule.beam8.test.jsonl"
    },
    {
        __plum_type__: "d2t.e2e_predict",
		...
		target_vocab: vocab["target"],
		input_path: "../data/e2e/e2e.test.mrs.v6.lex.jsonl", 
		filename: "aug.rule.lex.greedy.test.jsonl"
    },
]
